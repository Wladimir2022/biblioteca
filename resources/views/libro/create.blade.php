...
@section('content2')
<div class="col-sm-6">
    <h1>Biblioteca Virtual-Ingreso de Libros</h1>
</div>
@endsection
@section('content3')
<div class="row">
    <div class="container-flat-form">
        <div class="title-flat-form title-flat-orange">Agregar un nuevo libro</div>
        @if (count($errors)>0)
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="código" class="form-control" value="{{ old('código') }}"
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" name="paginas" min="1" step="1" value="{{ old('paginas') }}"
